...
<html>
	...
	<body>
		<div data-custom-class="body">
			<div>
				<h1>
					<strong><span class="question">PRIVACY POLICY</span></strong>
				</h1>
			</div>
			<div>
					...
					><strong
						><span style="font-size: 15px"
							><span data-custom-class="subtitle"
								>Last updated <span class="question">August 20, 2025</span></span
							></span
						></strong
					></span
				>
				...
				<span style="color: rgb(127, 127, 127)"
					><span style="color: rgb(89, 89, 89); font-size: 15px"
						><span data-custom-class="body_text"
							>This Privacy Notice for <span class="question noTranslate">Modulee</span></span
						>
						...
						><span style="font-size: 15px; color: rgb(89, 89, 89)"
							><span data-custom-class="body_text"
								...
								<span style="color: rgb(0, 58, 250)"
									><span class="question noTranslate"
										><a href="https://modulee.app" target="_blank" data-custom-class="link"
											>https://modulee.app</a
										></span
									></span
								>
			...
			<div>
				<div style="line-height: 1.5">
						...
						<span style="font-size: 15px"
							><span style="color: rgb(127, 127, 127)"
								><span data-custom-class="body_text"
									...
									help you understand your privacy rights and choices. We are responsible for making
									...
									<span class="question noTranslate">moduleeapp@gmail.com</span>.</span
								></span
							></span
						>
					</div>
					...
					<div style="line-height: 1.5">
						<h2>
							<strong><span style="font-size: 15px">SUMMARY OF KEY POINTS</span></strong>
						</h2>
					</div>
					<div style="line-height: 1.5">
						<span style="font-size: 15px"
					...
					<div style="line-height: 1.5">
						<span style="font-size: 15px"
							><span data-custom-class="body_text"
								...
								do not process sensitive personal information.</span
							></span
						>
					</div>
					<div style="line-height: 1.5"><br /></div>
					...
					<div id="toc" style="line-height: 1.5">
						<h2>
							<span style="font-size: 15px"><strong>TABLE OF CONTENTS</strong></span>
						</h2>
						&nbsp;&nbsp;&nbsp;
					</div>
					<div style="line-height: 1.5">
					...
					<div style="line-height: 1.5">
						<a data-custom-class="link" href="#request"
							><span style="color: rgb(0, 58, 250)"
								>16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span
							></a
						>
					</div>
					<div style="line-height: 1.5"><br /></div>
							...
							<span style="font-size: 15px; color: rgb(89, 89, 89)"
								><span style="font-size: 15px; color: rgb(89, 89, 89)"
									><span data-custom-class="body_text"
										><span style="font-size: 15px"
											><span data-custom-class="body_text"
												><span class="question">email addresses</span></span
											></span
										></span
									></span
								></span
						...
						<span style="font-size: 15px; color: rgb(89, 89, 89)"
							><span style="font-size: 15px; color: rgb(89, 89, 89)"
								><span data-custom-class="body_text"
									...
									provider, as described in the section called "<span style="font-size: 15px"
										><span data-custom-class="body_text"
											><span style="font-size: 15px"
												><span style="color: rgb(0, 58, 250)"
													><a data-custom-class="link" href="#sociallogins"
					...
					<div style="line-height: 1.5">
						<h3>
							<span style="font-size: 15px"><strong>Google API</strong></span>
						</h3>
						<span data-custom-class="body_text"
																...
																><span style="color: rgb(89, 89, 89)"
																	><span style="color: rgb(89, 89, 89)"
																		><span data-custom-class="body_text"
																			...
																			contact you about your use of our Services.</span
																		></span
																	></span
																></span
															>
																											...
																											<em
																												><span style="font-size: 15px"
																													><span data-custom-class="body_text"
																														...
																														we believe it is necessary and we have a
																														valid legal reason (i.e., legal basis)
																														to do so under applicable law, like with
																														your consent, to comply with laws, to
																														provide you with services to enter into
																														or fulfill our contractual obligations,
																											...
																											>
																												<span style="font-size: 15px"
																													><span data-custom-class="body_text"
																														...
																														use your personal information for a
																														...
																														>
																															<span data-custom-class="body_text"
																																><span style="font-size: 15px"
																																	...
																																	so we can improve them to engage
																																	and retain users</span
																																></span
																															>
																														</li>
																													</ul>
																																			...
																																			<div style="line-height: 1.5">
																																				...
																																				>
																																					<span
																																						...
																																						><span
																																							...
																																							applicable laws) under
																																							applicable US state
																																							laws, you can opt out
																																							of these online
																																				...
																																				>
																																					...
																																					<span
																																						...
																																						each category and does
																																						not reflect the personal
																																				...
																																				>
																																					...
																																					>
																																						...
																																						<span
																																							...
																																							laws, if we decline to
																																							take action regarding
																																							your request, you may
																																							appeal our decision by
																																							emailing us at
																																							<span
																																								class="question noTranslate"
																																								>moduleeapp@gmail.com</span
