...
export const NodeSchema = z.discriminatedUnion('type', [
	...
	NodeBaseSchema('FloorNode', ['input'], [], z.object({})),
	...
	NodeBaseSchema('SineNode', ['input'], [], z.object({})),
